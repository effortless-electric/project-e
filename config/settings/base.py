...
)  # (project_e/config/settings/base.py - 3 = project_e/)
APPS_DIR = ROOT_DIR.path("project_e")
...
MIGRATION_MODULES = {"sites": "project_e.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "project_e.utils.context_processors.settings_context",
            ],
        },
    }
]
