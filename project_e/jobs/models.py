...
class Job(models.Model):
    customer = models.ForeignKey(User, blank=False, null=False, on_delete=models.CASCADE, related_name='buyer_to_job')
    dealership = models.ForeignKey(Dealer, blank=False, null=False, on_delete=models.CASCADE)
    seller = models.ForeignKey(User, blank=False, null=False, on_delete=models.CASCADE, related_name='seller_to_job')
    cont_id = models.ForeignKey(Contractor, blank=True, null=True, on_delete=models.CASCADE)
    sale_date = models.DateTimeField(_("Date of Sale"), default=datetime.now, blank=False)
    ...
    car_make = models.CharField(max_length=100, blank=False, null=False)
